...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Er9FIsEfr03pYmnzRSAb.ppPJGrIiS6IaVe80IPwYoW.7h7IS0GOXGGeYEKcUPIhOEkU+ZCXlTG66MxJLcqOZf8=')
kr.loginResult()

print "[SAIN BERHASIL LOGIN]"
reload(sys)
            ...
            if mid in op.param3:
              if wait["autoJoin"] == True:
                if op.param2 in Bots or admin:
                  ...
                  kr.sendText(op.param1, "Perkenalkan nama saya 🍁ԹɑƘ Տɑíղ✍️")
                  kr.sendText(op.param1, "Salam kenal semua")
                else:
...
#==============================================================================#
            ...
            elif msg.text in ["Wa'alaikumussallam"]:
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#==============================================================================#
            elif msg.text.lower() in ["tagfans","beb juga","vika juga","tagall juga","jones juga","dor juga","mpik juga"]:
                 group = kr.getGroup(msg.to)
