...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Eq5cYhTlf9b5w5vSRtt0.FrsaA4tXU9oyHmEWOFlkKa.QYBHwutXF8Qz2IH7zsi8u1y3GQ0K+ywmn0UAYCo2yt4=')
kr.loginResult()

print "[MASUKIN 1 BERHASIL LOGIN]"
reload(sys)
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u8c952aa7ca5a02b6aa4f47f75ccf3518"}
                kr.sendMessage(msg)
...
#==============================================================================#
            ...
            elif "Reqsong " in msg.text:
                try:
                    songname = msg.text.lower().replace("Reqsong ","")
                    params = {'songname': songname}
                    r = requests.get('http://ide.fdlrcn.com/workspace/yumi-apis/joox?' + urllib.urlencode(params))
                    data = r.text
                    data = json.loads(data)
