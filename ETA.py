...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='ErqC0EcyYrd5q7kll1w0.vxB9FHo5l/+EP425wsCIKa.c++oHo0T71TT3r5tRQALe+KpZCLcYrYyEVr+/rVMItE=')
kr.loginResult()

print "[ETTA BERHASIL LOGIN]"
reload(sys)
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Tʜᴀɴᴋꜱ ғᴏʀ ᴀᴅᴅ ᴍᴇ\nBʏ: line.me//ti/p/~tak.dapat.tidur\nIɴᴠɪᴛᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ヘ(^_^)ヘ\nBᴏᴛ Pᴜʙʟɪᴄ:\nline.me/ti/p/~sain.botpublik",
    "lang":"JP",
    "comment":"Iɴᴠɪᴛᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ヘ(^_^)ヘ\nBᴏᴛ Pᴜʙʟɪᴄ:\nline.me/ti/p/~sain.botpublik",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
            ...
            if mid in op.param3:
              if wait["autoJoin"] == True:
                if op.param2 in Bots or admin:
                  kr.acceptGroupInvitation(op.param1)
                  kr.sendText(op.param1, "Tᴇʀɪᴍᴀ ᴋᴀꜱɪʜ ᴛᴇʟᴀʜ ᴜɴᴅᴀɴɢ ꜱᴀʏᴀ")
                  kr.sendText(op.param1, "Pᴇʀᴋᴇɴᴀʟᴋᴀɴ ɴᴀᴍᴀ ꜱᴀʏᴀ Etta queen")
                else:
 ...
 #                    contact = kr.getContact(msg.from_)
 #                    cName = contact.displayName
 #                    balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","Saya lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "uff3c9e9b542d5d6febfba82c2e634847"}
                kr.sendMessage(msg)
            elif cms(msg.text,["creator","Creator"]):
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u3cfa63811888b3a880bc4f348a95b23b"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'Creator👉 line.me/ti/p/~tak.dapat.tidur')
...
#==============================================================================#
            ...
            elif msg.text in ["Wa'alaikumsallam"]:
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#==============================================================================#
            elif msg.text.lower() in ["etta","netha"]:
                 group = kr.getGroup(msg.to)
...
#================================ KRIS SCRIPT STARTED ==============================================#
              ...
              if msg.from_ in admin:
                ...
                kr.sendMessage(msg)
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    kr.sendText(msg.to,_name + " Cʜᴇᴄᴋ Yᴏᴜʀ Gɪғᴛ Bᴏx")
                                    msg.contentType = 9
                                    msg.contentMetadata= {'PRDTYPE': 'STICKER',
                                                         'STKVER': '1',
                                                         'MSGTPL': '1',
                                    ...
                                    kr.sendMessage(msg)
                                    kr.sendMessage(msg)
                                    kr.sendText(msg.to,"Dᴏɴᴇ 5000 ᴄᴏɪɴ")
                                except:
            ...
            elif msg.text in ["hapus semua chat"]:
                if msg.from_ in owner:
...
#==============================================#
        ...
        if op.type == 17:
            if wait["Wc"] == True:
                ...
                kr.sendText(op.param1,"Hɪɪ... " + kr.getContact(op.param2).displayName + "")
                kr.sendText(op.param1,"Wᴇʟᴄᴏᴍᴇ Tᴏ " + str(ginfo.name) + "")
                kr.sendText(op.param1,"Sᴀʟᴋᴇɴ ʏᴀ...🙏👏")
                kr.sendText(op.param1,"Dᴀɴ ꜱᴇᴍᴏɢᴀ ʙᴇᴛᴀʜ ᴅɪꜱɪɴɪ ^_^")
        ...
        if op.type == 15:
            if wait["Lv"] == True:
                ...
                kr.sendMessage(c)
                kr.sendImageWithURL(op.param1,image)
                kr.sendText(op.param1,"Gᴏᴏᴅ Bʏᴇ " + kr.getContact(op.param2).displayName +  "")
                kr.sendText(op.param1,"Sᴇᴇ Yᴏᴜ Nᴇxᴛ Tɪᴍᴇ . . . (p′︵‵。) 🤗")
