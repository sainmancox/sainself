...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='ErP0NusIJhcZb3AZZ1Ta.dRsBU7VnJrvYKkuhMHZfYG.BqVzsEuRrq5aL0qiP50Xy7koAOqbGALm6tIA6L0SV7M=')
kr.loginResult()

print "[LY BERHASIL LOGIN]"
reload(sys)
...
║╠  9. Restart
║╠ 10. lirik_text
║╠ 11. Tagfans (mentionall)
║╠ 12. cctv on/off (Lurk)
║╠ 13. toong (Lurker)
║╠ 14. Read on/off
║╠ 15. Getinfo_by tag
║╠ 16. Getcontact_by tag
║╠ 17. Sp/Speed
║╠ 18. Friendlist
║╠ 19. id@en
║╠ 20. en@id
...
#VIKA                                        kr.sendText(op.param1, "Hey u!! " + "" + Name + "" + "yang abis vcs. . .\npap deh sini (-__-)   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                    else:
                                        kr.sendText(op.param1, "Haii " + "" + Name + "" + "\nBisulan tujuh turunan cctv telus . . .\nChat Napa (-__-)   ")
#VIKA                                        kr.sendText(op.param1, "Hey u!! " + "" + Name + "" + "kang cilok, betah banget jadi sider. . .\ngift aim ih (-__-)   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                else:
                                    kr.sendText(op.param1, "Haii " + "" + Name + "" + "\nKak ngapain ngintip ? \nSini Dong ih..   ")
#VIKA                                    kr.sendText(op.param1, "Hey u!! " + "" + Name + "" + "\nkang intip tetangga???\nSini gabung chat...   ")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
 #                          else:
 #                               kr..sendText(op.param1, "Haii " + "" + Name + "" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (-__-)   ")
            ...
            if mid in op.param3:
              if wait["autoJoin"] == True:
                if op.param2 in Bots or admin:
                  ...
                  kr.sendText(op.param1, "Perkenalkan nama saya Ly.")
...
#VIKA                     balas = ["Don't Tag Me! iam Bussy!" ,cName + " Ada perlu apa ?", "Kenapa" ,cName + " Kangen?","Kangen bilang gak usah tag tag" ,cName + " Apasi?" ,cName + " Pulang gih" ,cName + " Ngapain Ngetag?", "Saya lagi off", "Saya lagi masturb" ,cName + " Kenapa Tag saya?","SPAM PC aja" ,cName + " Jangan Suka Tag gua, " ,cName + " Kamu siapa?" ,cName + " Kalo sange nggak usah Tag-Tag! Langsung Pc Aja" ,cName + " Maaf... Tidak Melayani Manusia RUWET!!!\ndalam bentuk dan jenis apapun" ,cName + " KAMU KOK JANCOK YA?" ,cName + " Ruwet Tak Pancal RAIMU"]
                     ...
                     for mention in mentionees:
                           if mention['M'] in Bots:
                                  ...
                                  break
#VIKA                                  lang = 'id'
#VIKA                                  tts = gTTS(text=ret_, lang=lang)
#VIKA                                  tts.save("hasil.mp3")
#VIKA                                  kr.sendText(msg.from_,ret_)
#VIKA                                  kr.sendText(msg.to,ret_)
#VIKA                                  kr.sendAudio(msg.to,"hasil.mp3")
#VIKA                                  break
            if 'MENTION' in msg.contentMetadata.keys() != None:
...
#===================================================================================================
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "uc4ee311821143203df997ba4a6b47824"}
                kr.sendMessage(msg)
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#==============================================================================#
            elif msg.text.lower() in ["beb","beb juga","vika juga","tagall juga","jones juga","dor juga"]:
                 group = kr.getGroup(msg.to)
