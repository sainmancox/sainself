...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='ErZqNlT6kpRWZ8Ohprv4.UJ5YrKKhNoXOeGuE9xSy9a.foJrv7AXE0x6UCIFkUUIV86n0k99phpwo7Ego32EoBY=')
kr.loginResult()

print "[MPIK BERHASIL LOGIN]"
reload(sys)
            ...
            if mid in op.param3:
              if wait["autoJoin"] == True:
                if op.param2 in Bots or admin:
                  ...
                  kr.sendText(op.param1, "Perkenalkan nama saya M p i k􀨁􀄆􏿿")
...
#===================================================================================================
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "uba3e724649079cec6812051ef57b18f4"}
                kr.sendMessage(msg)
...
#==============================================================================#
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        pass
#==============================================================================#
            elif msg.text.lower() in ["mpik","beb juga","vika juga","tagall juga","jones juga","dor juga"]:
                 group = kr.getGroup(msg.to)
